...
export default function HomeScreen() {
  ...
  function handleSubmit() {
    ...
    navigate(`/review?amount=${amount.toString()}`);
  }
          ...
          <div className="flex text-left justify-between items-center bg-neutral-50 border border-neutral-200 rounded-2xl p-5">
            <div className="flex flex-row gap-3 items-start">
              ...
              <div>
                ...
                <div className="font-semibold text-2xl hidden md:block">Arbitrum</div>
            ...
            <div className="flex flex-row gap-3 items-start">
              ...
              <div>
                ...
                <div className="font-semibold text-2xl hidden md:block">Ethereum</div>
            ...
            <div className="flex justify-between items-center w-full">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <div className="text-neutral-500">Balance {arbBalance.slice(0, 10)}</div>
                </div>
              </div>
